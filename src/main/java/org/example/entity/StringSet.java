...
public class StringSet {
    public static String a = "Carroll began writing the manuscript of the story the next day, although that earliest version is lost. " +
    ...
    public static Set<String> findUniqueWords() {
        String cleaned = a.replaceAll("[^a-zA-Z\\s]", "").toLowerCase();
        String[] wordList = cleaned.split("\\s+");
        Set<String> uniqueWordList = new TreeSet<>();
        Collections.addAll(uniqueWordList, wordList);
